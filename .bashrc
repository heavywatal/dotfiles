...
FZF_DEFAULT_OPTS="$FZF_DEFAULT_OPTS --popup=top,100%,95%"
...
if [ "$(uname)" = Darwin ]; then
  ...
  alias saccto='sacct -o JobID,JobName,User,State,ExitCode%6,Start,Elapsed,ReqCPUs%4,NCPUs%4,TotalCPU,ReqMem%6,MaxRSS%6'
fi
